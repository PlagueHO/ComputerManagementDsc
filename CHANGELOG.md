...
- Added `AGENTS.md` at repository root with build/test workflow, resource type overview,
  and key conventions for AI agents - Fixes [Issue #464](https://github.com/dsccommunity/ComputerManagementDsc/issues/464).
